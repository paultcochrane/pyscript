...
\Verb|P| or \Verb|R|) in it's contructions with a specifier for a
...
which takes two points as arguments --- they are the control
points of the bezier. If one of the points is omitted then both
control points will be set to the one specified point.
...
\Verb|f| along the path with \Verb|path.P(f)|.
\begin{example}
\begin{python}
