...
\begin{figure}[ht]
\centerline{\includegraphics[width=\figwidth]{optics/michelson-morely.eps}}
...
\begin{figure}[ht]
\centerline{\includegraphics[width=\figwidth]{optics/sagnac.eps}}
...
\begin{figure}[ht]
\centerline{\includegraphics[width=\figwidth]{optics/fabry-perot_pdh.eps}}
...
\begin{figure}[ht]
\centerline{\includegraphics[height=0.1\textheight]{optics/BSBox.eps}}
...
\begin{figure}[ht]
\centerline{\includegraphics[height=0.1\textheight]{optics/BSLine.eps}}
...
\begin{figure}[ht]
\centerline{\includegraphics[height=0.1\textheight]{optics/Detector.eps}}
...
\begin{figure}[ht]
\centerline{\includegraphics[height=0.1\textheight]{optics/FreeSpace.eps}}
...
\begin{figure}[ht]
\centerline{\includegraphics[height=0.1\textheight]{optics/LambdaPlate.eps}}
...
\begin{figure}[ht]
\centerline{\includegraphics[height=0.1\textheight]{optics/Laser.eps}}
...
\begin{figure}[ht]
\centerline{\includegraphics[height=0.1\textheight]{optics/Lens.eps}}
\caption{Lens object}
\label{fig:lens}
\end{figure}
...
\begin{figure}[ht]
\centerline{\includegraphics[height=0.1\textheight]{optics/Mirror.eps}}
...
\begin{figure}[ht]
\centerline{\includegraphics[height=0.1\textheight]{optics/Modulator.eps}}
...
\begin{figure}[ht]
\centerline{\includegraphics[height=0.1\textheight]{optics/PhaseShifter.eps}}
