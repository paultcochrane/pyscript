...
%{prefix}/lib/python2.3/site-packages/pyscript/arrowheads.py
%{prefix}/lib/python2.3/site-packages/pyscript/arrowheads.pyc
...
%{prefix}/lib/python2.3/site-packages/pyscript/lib/present.py
%{prefix}/lib/python2.3/site-packages/pyscript/lib/present.pyc
